...
class HQWebsitePricingCalculatorShortcode2022{

    public function __construct()
    {
        add_shortcode("hq_website_rate_calculator_2022", array($this, 'hqWebsitePricingCalculator'));
    }
    public function hqWebsitePricingCalculator()
    {
        ...
        wp_enqueue_script('hq-calculator-shortcode-js-2022');
        ?>
        <script>
        ...
        <div id="hq-calculator-app-2022"></div>
        <style>
